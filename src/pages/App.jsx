...
import TalentCategoriesFormContainer from './TalentCategoriesFormContainer';
  ...
  return (
    <PageLayout>
      ...
      <Switch>
        ...
        <Route exact path="/:talentOrPassion/:categoryUrl" component={TalentCategoriesFormContainer} />
